...
| `tools/edit-config/edit_config.py`      | Surgical editor: add/remove publishers, set minPublishers, set state, set/clear RIC identifiers, add/remove exchangeId (schedule inheritance)                                              | `python3 tools/edit-config/edit_config.py --config after.json --add-publisher 80 --feed-id 1000-1050`  | [docs/edit_config.md](docs/edit_config.md)                               |
