...
| `lazer_dq/apply_allowed_to_config.py`  | Apply dq_summary "allowed" sheet to after.json (promote COMING_SOON→STABLE + add sessions)             | `python3 -m lazer_dq.apply_allowed_to_config --xlsx dq_summary_X.xlsx --config after_1.json --dry-run` | [docs/apply_allowed_to_config.md](docs/apply_allowed_to_config.md)       |
