...
Copied from tools/edit-config/edit_config_lib/config_text_surgery.py to keep
session-editor self-contained per the README's "independence" convention.
The primitives are stable; if they evolve in edit-config, sync them here.
"""
