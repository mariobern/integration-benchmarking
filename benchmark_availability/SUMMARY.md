...
.DXY, AUD, AUDCAD=R, AUDCHF=R, AUDJPY, AUDNZD, BRL, CAD, CADCHF, CADCHF=R, CADJPY, CHF, CHFJPY, CLP, CNH, CNY, COP, CZK, DKK, EUR
... and 40 more
...
Brent Crude (LCO), Copper (HG), E-Mini Nasdaq-100 (NQ), E-Mini S&P 500 (ES), Mini Dow (YM), WTI Crude Oil (CL)
